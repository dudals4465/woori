...
<div class="stateBox">
	...
	<div class="stepBox">
		...
		<span class="step on">2</span>
		<span class="step">3</span>
	</div>
</div>
<div class="form">
	<form id="formCertify" action="/login/confirm" method="POST">
		<dl class="confirm">
			<dt>인증번호</dt>
			<dd class="confirmBox">
				<input type="text" name="certify" value="123456" maxlength="6"  onkeypress="onlyNumber();" pattern="[0-9]*" inputmode="numeric" placeholder="문자로 받은 인증번호 6자리" >
				<span>3:00</span>
			</dd>
			<dt>이용약관</dt>
			<dd class="agree">
		...
		<div class="buttonBox">
			<button id="confirmCertifyNo" class="cyan">확인</button>
		</div>
	</form>
</div>
<div class="guide off">
...
제1조(목적)
이 약관은 우리금융캐피탈주식회사(이하 “회사”라 한다)가 운영하는 온라인서비스(이하 “서비스”라 한다)를 이용함에 있어 이용자의 권리·의무 및 책임사항과 서비스 이용에 대한 기타 필요한 사항을 규정함을 목적으로 합니다.
...
- 고유식별정보 : 주민등록번호, 운전면허번호, 여권번호, 외국인등록번호
	...
	<div id="apiView">
		...
		<div id="apiResponsePage" style="word-break:break-all"></div>
			...
			<div class="footer">
				<span class="phone">서비스 이용 문의 : <strong>1800-1110</strong></span>
				<span class="right"><em>HANA CAPITAL</em> CO.,LTD. ALL RIGHT RESERVED</span>
			</div>
  ...
  ["trSno"]=>
  string(15) "202012300000005"
  ["slfCnfmMngeNo"]=>
  string(13) "2020123000004"
  ["mode"]=>
  string(4) "aict"
}
    ...
    <div class="layerPopup webType pcSize">
        <div class="dimBg"></div>
    ...
    <div class="loadingPopup webType pcSize">
        <div class="dimBg"></div>
        <div class="frame"></div>
    </div>