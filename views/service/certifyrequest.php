...
<div class="form">
	<form id="formCertify" action="/login/certify" method="POST">
		<dl class="line call">
			<dt>이름</dt>
			<dd><input type="text" name="name" value="홍길동" placeholder="주민등록에 등록된 이름" ></dd>
			<dt>생년월일</dt>
			<dd><input type="text" name="birth" value="19990101" maxlength="8"  onkeypress="onlyNumber();" pattern="[0-9]*" inputmode="numeric" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="주민등록 생년월일 (8자리 숫자만)" ></dd>
			<dt>국적</dt>
			<dd class="radioBox">
			...
			<dd class="multi">
				...
				<div class="phone">
					...
					<input type="text" name="phone" value="01012345678" maxlength="11"  onkeypress="onlyNumber();" pattern="[0-9]*" inputmode="numeric" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="휴대폰 번호, 숫자만 입력">
				</div>
			</dd>
		</dl>
		<div class="buttonBox">
			<button id="applyCertifyNo" class="cyan">인증번호 요청</button>
		</div>
	</form>
</div>
